...
3.  We denote by $\mathbf{b}$ the OLS estimator of $\beta$ in the regression of $c_i$ on $y_i$ (with no constant term). After expressing $\mathbf{b}$ as a function of $\beta$, $\mathbf{y}$ and $\mathbf{u}$, give the limit of $\mathbf{b}$ when $n \to \infty$ (the formula involves, in particular, $\mathbb{E}(y_i)$ and $\mathbb{V}ar(y_i)$).
