...
:::{.proposition #condcdf name="Conditional density"}
We have
$$
...
Except in degenerate cases, an estimate differs from the "true" (or *population*) value. A good estimator is expected to approach the true value as the sample size increases. This property is called *consistency*.
