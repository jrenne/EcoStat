...
In practice, implementing this approach consists in running a linear regression of the type of Eq. \@ref(eq:DiD). These regressions often use time-invariant characteristics as controls instead of the ixed effects $\mu_i$. As illustrated in the next subsection, the parameter of interest ($\beta_1$) is often associated with an interaction term.
