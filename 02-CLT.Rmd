...
If the random variables $x_i$ are i.i.d. and if $\mathbb{E}(x_i)=\mu < \infty$, then the sample mean ($\overline{x}_n$) is a consistent estimator of the population mean ($\mu$). In other words, the sample mean converges in probability to the population mean.
:::
:::{.proof}
